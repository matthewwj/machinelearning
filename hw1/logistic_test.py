...
def get_branche_data(keys):
    ...
    print(f"Total size of dataset: {len(features)}")
...
def branche_data_test(lr=0.1, batch_size=32, epochs=50):
    ...
    #tune_hyperparameters(bag_of_words_feat_train, y_train, bag_of_words_feat_test, y_test)

    print('Logistic Regression Industry Codes Classifier')
